...
$Admin = $res['Admin'];
$img = $res['Image'];
if($Admin == 'Yes' && $res['Sname'] == 'Ahmed Amin'){
$Month = $mycon->query("SELECT DISTINCT Month(Date) AS MONTH FROM `buys` ORDER BY `MONTH` ASC");
$Year = $mycon->query("SELECT DISTINCT Year(Date) AS YEAR FROM `buys` ORDER BY `YEAR` ASC");
$D="";
?>
<html>
<head> 
<title>All Shoes Orders</title>
...
?>
<div align="center">
<a class="button" style="background:green;" href="ExportALLData.php">Export To Excel</a>
</div><br><br><br>	
...
$sql = "SELECT DISTINCT buys.CPhone,buys.SID,Pages.Platform,buys.ID,buys.Datetime,Month(Date) As Month,Year(Date) As Year, buys.Date,buys.sPrice,buys.Shipping,buys.Size,buys.Quantity,buys.Userprofit AS UserProfit,buys.Profit As TotProf,customers.Name,cities.city_name_ar, cities.city_name_en,
...
<br>
      ...
      <thead>
        <tr>  
          ...
          <th>Shoe Actual Price</th>
          <th>Shoe Minimum Price</th>
          <th>Shoe Sold Price</th>
          <th>Seller Image</th>
          <th>Seller Name</th>
...
<th>Customer's Address</th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="Shoe.php?ID=<?php echo $res['ID'];?>" class="text-dark"><img class="image"src="images/Shoes/<?php echo $res['SHOEIMG'];?>"></a></td>
          <td><?php echo $res['Model'];?></td>
          <td><?php echo $res['Platform'];?></td>
          <td><?php echo $res['Size'];?></td>
          <td><?php echo $res['Quantity'];?></td>
          <td><?php echo $res['Shipping'];?> LE.</td>
          <td><?php echo $res['ActualPrice']*$res['Quantity'];?> LE.</td>
			<?php
			 $TACPAK += $res['ActualPrice']*$res['Quantity'];
			?>
          <td><?php echo $res['MinPrice']*$res['Quantity'];?> LE.</td>
          <td><?php echo $res['sPrice']*$res['Quantity'];?> LE.</td>
          <td><a href="EORDER.php?SID=<?php echo $res['SID'];?>"><img class="image"src="images/<?php echo $res['SIMG'];?>"></a></td>
          <td><?php echo $res['Sname'];?></td>
          <td><?php echo $res['Name'];?></td>
          <td style='color:lavender;background:#6c7ae0;font-weight:bolder;'>+20<?php echo $res['CPhone'];?></td>
	  ...
	  <?php
		...
		?>
		    <td style="background:lightblue;color:navy;font-weight:bolder;font-size:20px;"><?php echo $res['TotProf'];?></td>
			<?php
			 $PROFIT += $res['TotProf'];
		  ...
		  <div>
			  <tr>
		  		<td style="background:rgb(57, 204, 199);color:lavender;font-weight:bolder;font-size:22px;"></td><td style="background:rgb(57, 204, 199);color:lavender;font-weight:bolder;font-size:22px;"></td><td style="background:rgb(57, 204, 199);color:white;font-weight:bolder"></td><td style="background:rgb(57, 204, 199);color:white;font-weight:bolder"></td><td style="background:rgb(57, 204, 199);color:white;font-weight:bolder"></td><td style="background:rgb(57, 204, 199);color:white;font-weight:bolder"></td><td style="background:rgb(57, 204, 199);color:white;font-weight:bolder"></td><td style="background:rgb(57, 204, 199);color:lavender;font-weight:bolder;font-size:22px;">Total Actual Price</td><td style="font-weight:bolder;color:purple;background-color:#2cc16a;font-size:22px"> <?php echo $TACPAK;?> LE.</td><td style="background:rgb(57, 204, 199);color:lavender;font-weight:bolder;font-size:22px;">Total Sold Price</td><td style="font-weight:bolder;color:purple;background-color:#2cc16a;font-size:22px"><?php echo number_format($TACPAK+$PROFIT);?> LE.</td><td style="background:rgb(57, 204, 199);color:white;font-weight:bolder"></td><td style="background:rgb(57, 204, 199);color:white;font-weight:bolder"></td><td style="background:rgb(57, 204, 199);color:white;font-weight:bolder"></td><td style="background:rgb(57, 204, 199);color:white;font-weight:bolder"></td><td style="background:rgb(57, 204, 199);color:white;font-weight:bolder"></td><td style="background:rgb(57, 204, 199);color:lavender;font-weight:bolder;font-size:22px;"></td><td style="font-weight:bolder;color:purple;background-color:rgb(57, 204, 199);font-size:22px"></td><td style="background:rgb(57, 204, 199);color:navy;font-weight:bolder;font-size:22px;"></td><td style="background:rgb(57, 204, 199);color:navy;font-weight:bolder;font-size:22px;"></td>
		  	</tr>
		   <tr>
...
<td style="background:#003399;color:lavender;font-weight:bolder;font-size:22px;"></td>
		  ...
		  <tr>
			  <td style="background:#000000;color:navy;font-weight:bolder;font-size:22px;"><td style="background:#000000;color:navy;font-weight:bolder;font-size:22px;"><td style="background:#000000;color:navy;font-weight:bolder;font-size:22px;"><td style="background:#000000;color:navy;font-weight:bolder;font-size:22px;"><td style="background:#000000;color:navy;font-weight:bolder;font-size:22px;"><td style="background:#000000;color:navy;font-weight:bolder;font-size:22px;"><td style="background:#000000;color:navy;font-weight:bolder;font-size:22px;"><td style="background:#000000;color:navy;font-weight:bolder;font-size:22px;"><td style="background:#000000;color:navy;font-weight:bolder;font-size:22px;"><td style="background:#000000;color:navy;font-weight:bolder;font-size:22px;"><td style="background:#000000;color:navy;font-weight:bolder;font-size:22px;"><td style="background:#000000;color:navy;font-weight:bolder;font-size:22px;"><td style="background:#000000;color:navy;font-weight:bolder;font-size:22px;"><td style="background:#000000;color:navy;font-weight:bolder;font-size:22px;"></td><td style="background:#000000;color:navy;font-weight:bolder;font-size:22px;"><td style="background:#000000;color:navy;font-weight:bolder;font-size:22px;"><td style="background:#000000;color:navy;font-weight:bolder;font-size:22px;"><td style="background:#000000;color:navy;font-weight:bolder;font-size:22px;"><td style="background:#000000;color:lavender;font-weight:bolder;font-size:22px;">Total Profit</td><td style="font-weight:bolder;color:purple;background-color:#2cc16a;font-size:22px"><?php echo number_format($PROFIT);?> LE.</td>
		  </tr>
			</div>
      </tbody>
    </table>
...
?>
	<div align="center">
<a class="button" style="background:green;" href="ExportAllDataYear.php?Year=<?php echo $Year;?>">Export To Excel</a>
</div><br><br><br>	
<form method="post" action="<?php $_PHP_SELF ?>">
<label class="radio"> 
...
<?php
$Monthz = $mycon->query("SELECT DISTINCT Month(Date) AS MONTH,Year(Date) FROM `buys` WHERE Year(Date) = $Year ORDER BY `MONTH` ASC");
...
$sql = "SELECT DISTINCT buys.CPhone,buys.SID,Pages.Platform,buys.ID,buys.Datetime,Month(Date) As Month,Year(Date) As Year, buys.Date,buys.sPrice,buys.Shipping,buys.Size,buys.Quantity,buys.Userprofit AS UserProfit,buys.Profit As TotProf,customers.Name,cities.city_name_ar, cities.city_name_en, governorates.governorate_name_ar,governorates.governorate_name_en, customers.Name,customers.Gender,customers.City,customers.Address,city.Governorate,shoes.Model,shoes.Brand,buys.MinP AS MinPrice,buys.ActualPrice,shoes.Profit,shoes.Image AS SHOEIMG, salesperson.Image AS SIMG, salesperson.Sname,salesperson.Gender From buys JOIN customers ON buys.CPhone = customers.CPhone JOIN salesperson ON buys.SID = salesperson.SID JOIN shoes ON buys.ID = shoes.ID JOIN shoesquantity ON shoes.ID = shoesquantity.ID JOIN city ON customers.City = city.CityID JOIN Pages ON Pages.ID=buys.PN JOIN cities ON cities.id = customers.Zone JOIN governorates on governorates.id=customers.Governorate WHERE Year(Date) = '$Year' ORDER BY `buys`.`Datetime` DESC";
$ALL = mysqli_query($mycon,$sql);
...
<div align='center'>
<a class="button button3" href="AminKolo.php">Back To All</a><br><br><br><br>
<a class="button" href="Products.php">Make New Order</a><br><br><br><br>
<a class="button button2" href="SellerOrders.php">View My Orders</a><br><br><br><br>
<a class="button button4" href="InventoryS.php">View Inventory</a><br><br><br><br>
<a class="button button1" href="EmployeeS.php">View Employees</a><br><br><br><br>
...
?>
	...
	<div align="center">
<a class="button" style="background:green;" href="ExportAllDataMonth.php?Month=<?php echo $Month;?>&amp;Year=<?php echo $Year;?>">Export To Excel</a>
</div><br><br><br>	
<label class="radio"> 
...
<?php
$sql = "SELECT DISTINCT buys.CPhone,buys.SID,Pages.Platform,buys.ID,buys.Datetime,Month(Date) As Month,Year(Date) As Year, buys.Date,buys.sPrice,buys.Shipping,buys.Size,buys.Quantity,buys.Userprofit AS UserProfit,buys.Profit As TotProf,customers.Name,cities.city_name_ar, cities.city_name_en, governorates.governorate_name_ar,governorates.governorate_name_en, customers.Name,customers.Gender,customers.City,customers.Address,city.Governorate,shoes.Model,shoes.Brand,buys.MinP AS MinPrice,buys.ActualPrice,shoes.Profit,shoes.Image AS SHOEIMG, salesperson.Image AS SIMG, salesperson.Sname,salesperson.Gender From buys JOIN customers ON buys.CPhone = customers.CPhone JOIN salesperson ON buys.SID = salesperson.SID JOIN shoes ON buys.ID = shoes.ID JOIN shoesquantity ON shoes.ID = shoesquantity.ID JOIN city ON customers.City = city.CityID JOIN Pages ON Pages.ID=buys.PN JOIN cities ON cities.id = customers.Zone JOIN governorates on governorates.id=customers.Governorate WHERE Month(Date) = '$Month' AND Year(Date) = '$Year'  ORDER BY `buys`.`Datetime` DESC ";
$ALL = mysqli_query($mycon,$sql);
