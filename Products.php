...
<div class="input-group">
  <input type="search" list="Cats" class="form-control rounded" placeholder="Search For A Specific Brand" name="SAD" aria-label="Search"
...
<div class="container py-5">
    ...
    <header class="text-center mb-5">
        <h1 class="display-4 font-weight-bold">Shoes Data</h1>
    </header>
        ...
        <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
            ...
            <div class="card rounded shadow-sm border-0">
                <div class="card-body p-4">
                    <a href="Shoe.php?ID=<?php echo $res['ID'];?>" class="text-dark" style="color:red;"><img src="images/Shoes/<?php echo $img;?>" alt="<?php echo $res['Model'];?>" class="img-fluid d-block mx-auto mb-3"></a>
                    <h5>Product Model : <a href="Shoe.php?ID=<?php echo $res['ID'];?>" class="text-dark" style="color:red;"><?php echo $res['Model'];?></a></h5>
...
$Search = mysqli_query($mycon,"SELECT UPPER(shoes.Model) AS Model,Image ,UPPER(shoes.Brand) AS Brand,ID,Price,Profit FROM `shoes` WHERE Brand  = '$A' ");
?>
<div class="container py-5">
    <!-- For Demo Purpose-->
    <header class="text-center mb-5">
...
$Sizez = $mycon->query("SELECT * FROM shoesquantity WHERE ID = '$rez[ID]'");
...
?>
        <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
            ...
            <div class="card rounded shadow-sm border-0">
                <div class="card-body p-4">
                    <a href="Shoe.php?ID=<?php echo $rez['ID'];?>" class="text-dark" style="color:red;"><img src="images/Shoes/<?php echo $img;?>" alt="<?php echo $rez['Model'];?>" class="img-fluid d-block mx-auto mb-3"></a>
                    <h5>Product Model : <a href="Shoe.php?ID=<?php echo $rez['ID'];?>" class="text-dark" style="color:red;"><?php echo $rez['Model'];?></a></h5>
                   <p class="small text-muted font-italic">Avilable Quantities : <?php echo $ZAD;?></p>
...
<a class="a" href="Products.php">Back To All Products</a>
</div>	
<?php
}
