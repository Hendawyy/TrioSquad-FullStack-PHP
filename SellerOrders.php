...
$TSAP="";
$TADP="";
$Month = $mycon->query("SELECT DISTINCT Month(Date) AS MONTH FROM `buys` WHERE SID = $ID ORDER BY `MONTH` ASC");
$Year = $mycon->query("SELECT DISTINCT Year(Date) AS YEAR FROM `buys` WHERE SID = $ID ORDER BY `YEAR` ASC");
$D="";
$Count=0;
?>
...
<?php
$sql = "SELECT buys.CPhone As Phone,customers.Name,city.Governorate,buys.ActualPrice,shoes.ID,Month(Date) As Month, Year(Date) As Year,Date,SID,Datetime,sPrice as SoldPrice,buys.Userprofit as SellerProfit,shoes.Profit AS SP,buys.Profit As TotProf,Shipping,Size,Quantity,Name As CustomerName,Gender,Address,Model,brand,buys.MinP as MinimumPrice,shoes.Image FROM `buys` JOIN customers on buys.CPhone = customers.CPhone JOIN city ON customers.City = city.CityID JOIN shoes on buys.ID=shoes.ID WHERE SID = '$ID' ORDER BY `buys`.`Datetime` DESC ";
...
<div class="table-wrapper">
    <table class="fl-table" id ='myTable'>
        ...
        <tr>
			...
			<th>Total Profit</th>
			<?php
			}else if($Admin == 'NO' && $Name != 'Bassem Khaled'){
			?>
      ...
      <th>Extra Profit</th>
			...
			<th>Shoe Shipping price</th>
			<?php
			}else if($Admin == 'Yes' && $Name == 'Mohamed Ali'){
        ?>
...
<tbody>
      ...
      <td><?php  echo $A;?> LE.</td>
        ...
        <?php
            ...
            <td><a href='UpdateOrderForm.php?DT=<?php echo $res['Datetime'];?>&amp;P=<?php echo $res['Phone'];?>&amp;SHID=<?php echo $res['ID'];?>&amp;QTY=<?php echo $res['Quantity'];?>&amp;Size=<?php echo $res['Size'];?>&amp;SPPU=<?php echo $res['SoldPrice'];?>&amp;D=<?php echo $res['Date'];?>&amp;G=<?php echo $res['Gender'];?>'><i class="fa fa-edit" style='font-size:38px;color:skyblue'></i></a></td>
			<td><a href='DeleteOrder.php?DT=<?php echo $res['Datetime'];?>&amp;P=<?php echo $res['Phone'];?>&amp;SHID=<?php echo $res['ID'];?>&amp;QTY=<?php echo $res['Quantity'];?>&amp;Size=<?php echo $res['Size'];?>&amp;SID=<?php echo $res['SID'];?>'><i class='fa fa-trash-o' style='font-size:38px;color:crimson'></i></a></td>
        </tr>
		...
		?>
				...
				<?php
				if($Admin == 'NO' && $Name != 'Bassem Khaled'){
				?>
	<tr>
				...
				<td style="background-color:rgba( 71, 147, 227, 1);"></td><td style="background-color:rgba( 71, 147, 227, 1);"></td><td style="background-color:rgba( 71, 147, 227, 1);"></td><td style="background-color:rgba( 71, 147, 227, 1);"></td>
				<td style="font-weight:bolder;color:red;background-color:skyblue;font-size:16px">Total <?php echo $rez['Sname']; ?> 's Profit</td><td style="font-weight:bolder;color:purple;background-color:#2cc16a;font-size:20px;"><?php echo $TTP;?> LE.</td><td style="background-color:rgba( 71, 147, 227, 1);"></td><td style="background-color:rgba( 71, 147, 227, 1);"></td><td style="background-color:rgba( 71, 147, 227, 1);"></td><td style="background-color:rgba( 71, 147, 227, 1);"></td><td style="background-color:rgba( 71, 147, 227, 1);"></td><td style="background-color:rgba( 71, 147, 227, 1);"></td><td style="background-color:rgba( 71, 147, 227, 1);"></td><td style="background-color:rgba( 71, 147, 227, 1);"></td>
				</tr>
				<?php
				}else if($Admin == 'Yes' && $Name == 'Ahmed Amin'){
				?>
	<tr>
		<td style="background-color:rgba( 71, 147, 227, 1);"></td>
				<td style="background-color:rgba( 71, 147, 227, 1);"></td><td style="background-color:rgba( 71, 147, 227, 1);"></td><td style="background-color:rgba( 71, 147, 227, 1);"></td><td style="background-color:rgba( 71, 147, 227, 1);"></td><td style="background-color:rgba( 71, 147, 227, 1);"></td>
				<td style="font-weight:bolder;color:red;background-color:skyblue;font-size:16px">Total Shoe Sold Price</td><td style="font-weight:bolder;color:purple;background-color:#2cc16a;font-size:20px"><?php echo $TSSP;?> LE.</td>
				<td style="font-weight:bolder;color:red;background-color:skyblue;font-size:16px">Total Shoe Actual Price</td><td style="font-weight:bolder;color:purple;background-color:#2cc16a;font-size:20px"><?php echo $TSAP;?> LE.</td>
...
<a class="button button1" href="EmployeeS.php">View Employees</a><br><br><br><br>
	...
	if($Name == 'Ahmed Amin'){
		?>
<a class="button button4" href="a.php">See All Orders</a><br><br><br><br>
...
$sql = "SELECT buys.CPhone As Phone,customers.Name,city.Governorate,buys.ActualPrice,shoes.ID,Month(Date), Year(Date),Date,SID,Datetime,sPrice as SoldPrice,buys.Userprofit as SellerProfit,shoes.Profit AS SP,buys.Profit As TotProf,Shipping,Size,Quantity,Name As CustomerName,Gender,Address,Model,brand,buys.MinP as MinimumPrice,shoes.Image FROM `buys` JOIN customers on buys.CPhone = customers.CPhone JOIN city ON customers.City = city.CityID JOIN shoes on buys.ID=shoes.ID WHERE SID = $ID AND Year(Date) = $Year ORDER BY `buys`.`Datetime` DESC ";
...
<center><br>
<a class="button button3" href="SellerOrders.php">Back To All</a><br><br><br><br>
<a class="button button2" href="Products.php">Make New Order</a><br><br><br><br>
<?php
if($Admin == 'Yes'){
?>
...
<?php
$sql = "SELECT buys.CPhone As Phone,customers.Name,city.Governorate,buys.ActualPrice,shoes.ID,Month(Date), Year(Date),Date,SID,Datetime,sPrice as SoldPrice,buys.Userprofit as SellerProfit,shoes.Profit AS SP,buys.Profit As TotProf,Shipping,Size,Quantity,Name As CustomerName,Gender,Address,Model,brand,buys.MinP as MinimumPrice,shoes.Image FROM `buys` JOIN customers on buys.CPhone = customers.CPhone JOIN city ON customers.City = city.CityID JOIN shoes on buys.ID=shoes.ID WHERE SID = $ID AND Month(Date) = '$Month' AND Year(Date) = '$Year'  ORDER BY `buys`.`Datetime` DESC ";
