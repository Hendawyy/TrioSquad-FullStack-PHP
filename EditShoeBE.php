...
$sql = "UPDATE `shoes` SET `Model` = '$_POST[SM]', `Brand` = '$_POST[SB]', `Price` = '$_POST[minP]', `ActualPrice` = '$_POST[AP]', `Profit` = '$_POST[pr]'  WHERE `ID` = '$SHID'";
if (!$mycon->query($sql)) {	
...
<div class="alert" id="mydiv">
  <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
<strong>Congratulations!</strong> Shoe Data Updated Succesfully.
</div>
<?php
    require('InventoryS.php');
}
