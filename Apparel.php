...
error_reporting(0);
include("DBCONN.php");
$result = $mycon->query("SELECT * FROM Apparel WHERE AID = '$_GET[ID]'");
$res = mysqli_fetch_array ($result);
    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="card">
                    <div class="path"><a> Apparel's Data </a> </div>
                    <div class="row">
                        <div class="col-md-6 text-center align-self-center"> <img class="img-fluid" 
                        src="images/Apparel/<?php echo $res['Image'];?>"alt='<?php echo $res['Model'] ;?>'> </div>
                        <div class="col-md-6 info">
                            ...
                            <div class="row price">
							<?php
							$Sizes = $mycon->query("SELECT * FROM AppQuantity WHERE ID = '$_GET[ID]'");
							...
							<br />
								...
								<?php
									...
									<label class="radio"> 
											...
											<?php
									$Q = $mycon->query("SELECT Quantity FROM AppQuantity WHERE ID = '$_GET[ID]' AND Size = '$sizeselect'");
									$QS = mysqli_fetch_array ($Q)
											...
											<div><br></div>
												...
												<h3>&nbsp;There is &nbsp;<?php echo $QS['Quantity'];?>&nbsp;<?php echo $res['Type'];?>. </h3>
							...
							<div class="col-md-6 mb-3">
								...
								<option value="" selected disabled>Choose A Valid Qunatity... </option>
									<?php
								$Quantity = $mycon->query("SELECT Quantity FROM AppQuantity WHERE Size = '$sizeselect' AND ID= '$_GET[ID]'");
                    ...
                    <div class="row lower">
						...
						<div align='left'><a class="btn" href="Apparels.php">Back To Products</a></div>
                        <div align='center'><button class="btn" formaction="CustomerApparel.php?ID=<?php echo $_GET['ID'];?>">Add To Cart</button>
                    </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
