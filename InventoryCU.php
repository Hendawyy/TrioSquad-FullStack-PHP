...
<input type="text"  class="form__field"  id="myInput" onkeyup="myFunction()" placeholder="Search for Apparel.."/><br><br><br>
</div></center>
<div class="bs-example">
    ...
    $Sizes = $mycon->query("SELECT * FROM AppQuantity WHERE ID = $res[AID] ORDER BY `AppQuantity`.`Size` DESC;");
...
?>
            <tr class="<?php echo $Classes[$i] ;?>">
				...
				?>
				<td><a href='UserLogin.php'><img class='img' src="images/Apparel/<?php echo $img ;?>"alt='<?php echo $res['Model'] ;?>'></a></td>
				<?php
				}else if(isset($_SESSION['UserID'])){
				?>
				<td><a href="Apparel.php?ID=<?php echo $res['AID'];?>" class="text-dark">
					<img class='img' src="images/Apparel/<?php echo $img ;?>"alt='<?php echo $res['Model'] ;?>'>
					</a></td>
				<?php
				}
?>
...
?>
<button class="button button2" formaction="Apparels.php">Apparels</button><br><br><br><br>
