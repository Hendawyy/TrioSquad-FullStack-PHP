...
error_reporting(0);
include("DBCONN.php");
$Perfumes = mysqli_query($mycon,'SELECT * FROM `perfumes` WHERE perfumes.Quantity > 0  ORDER BY Model');
...
<div class="input-group">
  <input type="search" list="Cats" class="form-control rounded" placeholder="Search " name="SAD" aria-label="Search"
...
<div class="container py-5">
    ...
    <header class="text-center mb-5">
        <h1 class="display-4 font-weight-bold">Perfumes Data</h1>
    </header>
...
<?php
while ( $res = mysqli_fetch_array ($Perfumes))
{
	if($res['Quantity'] > 0){
	$img = $res['Image'];
?>
        <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
            ...
            <div class="card rounded shadow-sm border-0">
				<div class="card-body p-4"><a href="Perfume.php?ID=<?php echo $res['PerID'];?>" class="text-dark" style="color:red;"><img src="images/Perfumes/<?php echo $img;?>" alt="<?php echo $res['Model'];?>" class="img-fluid d-block mx-auto mb-3"></a>
                    <h5>Product Model : <a href="Perfume.php?ID=<?php echo $res['PerID '];?>" class="text-dark" style="color:red;"><?php echo $res['Model'];?></a></h5>
                    <p class="small text-muted font-italic">Avilable Quantity : <?php echo $res['Quantity'];?></p>
...
<?php
        ...
        <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
            <!-- Card-->
            <div class="card rounded shadow-sm border-0">
				<div class="card-body p-4"><img src="images/Perfumes/<?php echo $img;?>" alt="<?php echo $res['Model'];?>" class="img-fluid d-block mx-auto mb-3">
                    <h5>Product Model : <a href="Perfume.php?ID=<?php echo $res['PerID '];?>" class="text-dark" style="color:red;"><?php echo $res['Model'];?></a></h5>
                    <p class="small text-muted font-italic">Out Of Stock</p>
                     <h5>Price : <?php echo $res['Price'];?> LE.</h5>
                </div>
            </div>
        </div>
...
$Search = mysqli_query($mycon,"	SELECT * FROM `perfumes` WHERE perfumes.Gender = '$A' AND  perfumes.Quantity > 0  ORDER BY Model");
?>
<div class="container py-5">
    <!-- For Demo Purpose-->
    <header class="text-center mb-5">
...
?>
        <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
            <!-- Card-->
            <div class="card rounded shadow-sm border-0">
                <div class="card-body p-4"><a href="Perfume.php?ID=<?php echo $rez['PerID'];?>" class="text-dark" style="color:red;"><img src="images/Perfumes/<?php echo $img;?>" alt="<?php echo $rez['Model'];?>" class="img-fluid d-block mx-auto mb-3"></a>
                    <h5>Product Model : <a href="Perfume.php?ID=<?php echo $rez['PerID'];?>" class="text-dark" style="color:red;"><?php echo $rez['Model'];?></a></h5>
                    <p class="small text-muted font-italic">Avilable Quantity : <?php echo $rez['Quantity'];?> LE.</p>
...
<a class="a" href="Perfumes.php">Back To All Perfumes</a>
</div>	
<?php
}
