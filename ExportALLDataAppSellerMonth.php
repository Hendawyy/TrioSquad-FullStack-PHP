...
JOIN Apparel on BuyApp.ID=Apparel.AID WHERE BuyApp.SID= $ID AND Year(Date) = $Year AND
Month(Date) = $Month ORDER BY `BuyApp`.`Datetime` DESC");
...
if($Month == 1){
    ...
    $filename = $Name."'s Apparels Orders ".$D." ".$Year.".csv"; 
