...
$ID = $_SESSION['UserID'];
$Month = $mycon->query("SELECT DISTINCT Month(Date) AS MONTH FROM `buyper` ORDER BY `MONTH` ASC");
$Year = $mycon->query("SELECT DISTINCT Year(Date) AS YEAR FROM `buyper` ORDER BY `YEAR` ASC");
$D="";
?>
<html>
<title>All Perfumes Orders</title>
...
?>
<div align="center">
<a class="button" style="background:green;" href="ExportALLDataPer.php">Export To Excel</a>
</div><br><br><br>	
	...
	<table id ='myTable'>
      <thead>
        <tr>
          ...
          <th>Perfume Actual Price</th>
          <th>Perfume Minimum Price</th>
          <th>Perfume Sold Price</th>
          <th>Seller Image</th>
          <th>Seller Name</th>
...
<th>Customer's Address</th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><img class="image"src="images/Perfumes/<?php echo $res['SHOEIMG'];?>"></td>
          ...
          <td><?php echo $res['MinP']*$res['Quantity'];?> LE.</td>
          <td><?php echo $res['sPrice']*$res['Quantity'];?> LE.</td>
		<?php
			 $TACPAK += $res['ActualPrice']*$res['Quantity'];
			 $TSPAK += $res['MinP']*$res['Quantity'];
			 
			?>
          <td><a href="EORDERper.php?SID=<?php echo $res['SID'];?>"><img class="image"src="images/<?php echo $res['SIMG'];?>"></a></td>
          <td><?php echo $res['Sname'];?></td>
			<td><?php echo $res['Name'];?></td>
          <td style='color:lavender;background:#6c7ae0;font-weight:bolder;'>+20<?php echo $res['Phone'];?></td>
          ...
          <td><?php echo $res['DateTime'];?></td>
		   <?php
			 if($res['Sname'] == 'Asmaa Amin'){
				 ?>
				<td style = 'background:#4CAF50;color:#cfffe5;font-weight:bolder;font-size:20px;'><?php echo $res['UP'];?></td>
			<?php
				 $AsmaaAMIN += $res['UP'];
		  ...
		  ?>
				<td style = 'background:#4CAF50;color:#cfffe5;font-weight:bolder;font-size:20px;'><?php echo $res['UP'];?></td>
			<?php
				  $Arsanybeshara += $res['UP'];
			 }else if($res['Sname'] == 'Tarek Abd El Azim'){
		  ?>
				<td style = 'background:#4CAF50;color:#cfffe5;font-weight:bolder;font-size:20px;'><?php echo $res['UP'];?></td>
			<?php
				  $Tarek3bdl3azim += $res['UP'];
		   ...
		   $FaresAsh += $res['UP'];
				 ...
				 <td style = 'background:#4CAF50;color:#cfffe5;font-weight:bolder;font-size:20px;'><?php echo number_format($res['UP']);?></td>
		 <?php
				$AsmaaAMIN += $Zero;
				$IbrahimAmin += $Zero;
				$Bassem5aled += $Zero;
			...
			$Tot=$res['Ahmed']+$res['Ziad'];

		?>
          <td style="background:black;color:white;font-weight:bolder;font-size:20px;"><?php echo number_format($Tot);?></td>
			<?php
		...
		<tr>
		  ...
		  <tr>
			  <td style="background:#6a5acd;color:navy;font-weight:bolder;font-size:22px;"></td>
			  <td style="background:#6a5acd;color:navy;font-weight:bolder;font-size:22px;"></td><td style="background:#6a5acd;color:navy;font-weight:bolder;font-size:22px;"></td><td style="background:#6a5acd;color:navy;font-weight:bolder;font-size:22px;"></td><td style="background:#6a5acd;color:navy;font-weight:bolder;font-size:22px;"></td><td style="background:#6a5acd;color:navy;font-weight:bolder;font-size:22px;"></td>
			  <td style="background:#6a5acd;color:navy;font-weight:bolder;font-size:22px;"></td><td style="background:#6a5acd;color:navy;font-weight:bolder;font-size:22px;"></td><td style="background:#6a5acd;color:navy;font-weight:bolder;font-size:22px;"></td><td style="background:#6a5acd;color:navy;font-weight:bolder;font-size:22px;"></td><td style="background:#6a5acd;color:navy;font-weight:bolder;font-size:22px;"></td><td style="background:#6a5acd;color:navy;font-weight:bolder;font-size:22px;"></td><td style="background:#6a5acd;color:navy;font-weight:bolder;font-size:22px;"></td><td style="background:#6a5acd;color:navy;font-weight:bolder;font-size:22px;"></td><td style="background:#6a5acd;color:navy;font-weight:bolder;font-size:22px;"></td><td style="background:#6a5acd;color:navy;font-weight:bolder;font-size:22px;"></td><td style="background:#6a5acd;color:navy;font-weight:bolder;font-size:22px;"></td><td style="background:#6a5acd;color:navy;font-weight:bolder;font-size:22px;">Total Profit</td><td style="background:#2cc16a;color:purple;font-weight:bolder;font-size:24px;"><?php echo number_format($Totprof);?> LE.</td>
		  </tr>
			</div>
      </tbody>
    </table>
...
<br>
<div align='center'>
<a class="button" href="Perfumes.php">Make New Order</a><br><br><br><br>
<a class="button button2" href="SellerOrdersPerfumes.php">View My Orders</a><br><br><br><br>
<a class="button button4" href="InventoryP.php">View Inventory</a><br><br><br><br>
...
?>
	<div align="center">
<a class="button" style="background:green;" href="ExportALLDataPerYear.php?Year=<?php echo $Year;?>">Export To Excel</a>
</div><br><br><br>	
<form method="post" action="<?php $_PHP_SELF ?>">
<label class="radio"> 
...
<?php
$Monthz = $mycon->query("SELECT DISTINCT Month(Date) AS MONTH,Year(Date) FROM `buyper` WHERE Year(Date) = $Year ORDER BY `MONTH` ASC");
...
$sql = "SELECT DISTINCT buyper.CPhone AS Phone,customers.Name,customers.Name,Platform,customers.Gender,customers.Address, customers.Name,cities.city_name_ar, cities.city_name_en, governorates.governorate_name_ar,governorates.governorate_name_en, buyper.SID ,buyper.Page,buyper.PerID,buyper.DateTime,Month(Date) As Month,Year(Date) As Year,buyper.Date,buyper.sPrice,buyper.Shipping,buyper.Quantity AS Quantity,buyper.Userprofit AS UP,buyper.Ahmed,buyper.Ziad,perfumes.Image AS SHOEIMG,perfumes.Model,buyper.MinP,buyper.ActualPrice,perfumes.Quantity as pq,salesperson.Image AS SIMG, salesperson.Sname,salesperson.Gender From buyper JOIN salesperson ON buyper.SID = salesperson.SID JOIN perfumes on buyper.PerID=perfumes.PerID JOIN customers ON customers.CPhone=buyper.CPhone JOIN cities ON cities.id = customers.Zone JOIN governorates on governorates.id=customers.Governorate Join Pages on Pages.ID=buyper.PN WHERE Year(Date) = '$Year' ORDER BY `buyper`.`DateTime` DESC";
$ALL = mysqli_query($mycon,$sql);
...
<div align='center'>
<a class="button button3" href="AllPerfumesOrders.php">Back To All</a><br><br><br><br>
<a class="button" href="Perfumes.php">Make New Order</a><br><br><br><br>
<a class="button button2" href="SellerOrdersPerfumes.php">View My Orders</a><br><br><br><br>
<a class="button button4" href="InventoryP.php">View Inventory</a><br><br><br><br>
<a class="button button3" href="Logout.php">Logout</a><br><br><br><br>
...
?>
	...
	<div align="center">
<a class="button" style="background:green;" href="ExportALLDataPerMonth.php?Month=<?php echo $Month;?>&amp;Year=<?php echo $Year;?>">Export To Excel</a>
</div><br><br><br>	
<label class="radio"> 
...
<?php
$sql = "SELECT DISTINCT buyper.CPhone AS Phone,customers.Name,customers.Name,Platform,customers.Gender,customers.Address, customers.Name,cities.city_name_ar, cities.city_name_en, governorates.governorate_name_ar,governorates.governorate_name_en, buyper.SID ,buyper.Page,buyper.PerID,buyper.DateTime,Month(Date) As Month,Year(Date) As Year,buyper.Date,buyper.sPrice,buyper.Shipping,buyper.Quantity AS Quantity,buyper.Userprofit AS UP,buyper.Ahmed,buyper.Ziad,perfumes.Image AS SHOEIMG,perfumes.Model,buyper.MinP,buyper.ActualPrice,perfumes.Quantity as pq,salesperson.Image AS SIMG, salesperson.Sname,salesperson.Gender From buyper JOIN salesperson ON buyper.SID = salesperson.SID JOIN perfumes on buyper.PerID=perfumes.PerID JOIN customers ON customers.CPhone=buyper.CPhone JOIN cities ON cities.id = customers.Zone JOIN governorates on governorates.id=customers.Governorate Join Pages on Pages.ID=buyper.PN WHERE  Month(Date) = '$Month' AND Year(Date) = '$Year'ORDER BY `buyper`.`DateTime` DESC";
$ALL = mysqli_query($mycon,$sql);
