...
<title>Customer / Shoe Order Form</title>
<head>
...
<?php
$CT = mysqli_query($mycon,'SELECT * From `Pages` Where Type = "All";');
while ( $rec = mysqli_fetch_array ($CT)){
?>
...
<label>	
<?php
$SM = mysqli_query($mycon,"SELECT * From `shoes` Where ID = '$_GET[ID]' ");
...
<input type="text" name="momprice" hidden required value="<?php echo $rem['Price']; ?>"/>
<input type="text" name="APS" readonly hidden required value="<?php echo $rem['ActualPrice']; ?>"/>
</label>
...
<label>
<input type="submit" name="sub" value="Buy" formaction="ValidateCust.php" style="color:deepskyblue;font-weight: bolder;"><i class="icon ion-md-lock"></i>
</label>
<label>
	<a href="Shoe.php?ID=<?php echo $_GET['ID'];?>" style="color:teal;font-weight: bolder;text-decoration:none;">Back To Shoes</a><i class="icon ion-md-lock"></i>
</label>
<label>
	<a href="Products.php" style="color:dodgerblue;font-weight: bolder;text-decoration:none;">Back To All Shoes</a><i class="icon ion-md-lock"></i>
</label>
<label>
	<a href="SellerOrders.php" style="color:blue;font-weight: bolder;text-decoration:none;">View Orders</a><i class="icon ion-md-lock"></i>
