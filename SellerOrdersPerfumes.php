...
$TSAP;
$TADP;
$Month = $mycon->query("SELECT DISTINCT Month(Date) AS MONTH FROM `	buyper` WHERE SID = $ID ORDER BY `MONTH` ASC");
$Year = $mycon->query("SELECT DISTINCT Year(Date) AS YEAR FROM `buyper` WHERE SID = $ID ORDER BY `YEAR` ASC");
$D="";
$Count=0;
?>
...
<div class="table-wrapper">
    <table class="fl-table" id ='myTable'>
        ...
        <tr>
			...
			<th>Ahmed Profit</th>
			<?php
			}else if($Name != 'Ziad Mohamed' && $Name != 'Ahmed Amin'){
			?>
		...
		?>	
			...
			<td><a href='DeleteOrderper.php?DT=<?php echo $res['DateTime'];?>&amp;SHID=<?php echo $res['PerID'];?>&amp;QTY=<?php echo $res['Quantity'];?>&amp;SPPU=<?php echo $res['SoldPrice'];?>&amp;SID=<?php echo $rez['SID'];?>&amp;D=<?php echo $res['Date'];?>'><i class='fa fa-trash-o' style='font-size:38px;color:crimson'></i></a></td>
        </tr>
		<?php
			}
		?>
			<tr>
				...
				<?php
				if($Name != 'Ziad Mohamed' && $Name != 'Ahmed Amin'){
				?>
				...
				?>
				<td style="background-color:rgba( 71, 147, 227, 1);"></td><td style="background-color:rgba( 71, 147, 227, 1);"></td><td style="background-color:rgba( 71, 147, 227, 1);"></td><td style="background-color:rgba( 71, 147, 227, 1);"></td>
				<td style="font-weight:bolder;color:red;background-color:skyblue;font-size:16px">Total Perfume Sold Price</td><td style="font-weight:bolder;color:purple;background-color:#2cc16a;font-size:20px"><?php echo $TSSP;?> LE.</td>
				<td style="font-weight:bolder;color:red;background-color:skyblue;font-size:16px">Total Perfume Actual Price</td><td style="font-weight:bolder;color:purple;background-color:#2cc16a;font-size:20px"><?php echo $TSAP;?> LE.</td>
				<td style="font-weight:bolder;color:red;background-color:skyblue;font-size:16px">Total <?php echo $rez['Sname']; ?>'s Profit</td><td style="font-weight:bolder;color:purple;background-color:#2cc16a;;font-size:20px"><?php echo $TADP;?> LE.</td><td style="background-color:rgba( 71, 147, 227, 1);"></td><td style="background-color:rgba( 71, 147, 227, 1);"></td>
				<?php
				}
				?>
			</tr>
...
<a class="button" href="InventoryPU.php">All Perfumes</a><br><br><br><br>
<?php
if($Admin == 'Yes' || $rez['Sname']=='Ziad Mohamed'){
?>
<a class="button button1" href="InventoryP.php">See Inventory</a><br><br><br><br>
<a class="button button4" href="AllPerfumesOrders.php">See All Orders</a><br><br><br><br>
...
<center><br>
<a class="button button3" href="SellerOrdersPerfumes.php">Back To All</a><br><br><br><br>
<a class="button button2" href="Perfumes.php">Make New Order</a><br><br><br><br>
<a class="button" href="InventoryPU.php">All Perfumes</a><br><br><br><br>
<?php
if($Admin == 'Yes' || $rez['Sname']=='Ziad Mohamed'){
