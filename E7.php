...
<div class="errortext">This area is forbidden.</div><br>
<?php
error_reporting(0);
session_start();
include('DBCONN.php');
...
$Name = $rez['Sname'];
if($Name == 'Ziad Mohamed'){
	?>
	<div class="errortext"><a href="SellerOrdersPerfumes.php" style="Text-decoration:none;color:#FBD130;">Turn back now !</a></div>
<?php
}else{
?>
<div class="errortext"><a href="SellerOrders.php" style="Text-decoration:none;color:#FBD130;">Turn back now !</a></div>
<?php
}
}else{
