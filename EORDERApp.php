...
?>
<div align="center">
<a class="button" style="background:green;" href="ExportALLDataAppSeller.php?SID=<?php echo $ID?>">Export To Excel</a>
</div><br><br><br>	
<?php 
}
?>
...
?>
<div align="center">
<a class="button" style="background:green;" href="ExportALLDataAppSellerYear.php?SID=<?php echo $ID?>&amp;Year=<?php echo $Year;?>">Export To Excel</a>
</div><br><br><br>	
<?php
}
?>
...
?>
<div align="center">
<a class="button" style="background:green;" href="ExportALLDataAppSellerMonth.php?SID=<?php echo $ID?>&amp;Year=<?php echo $Year;?>&amp;Month=<?php echo $Month;?>">Export To Excel</a>
</div><br><br><br>	
<?php
}
?>
