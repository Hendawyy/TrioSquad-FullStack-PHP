...
<div class="bs-example">
    <table class="table table-striped table-dark" id ='myTable'>
        ...
        <tbody>
			...
			error_reporting(0);
			include("DBCONN.php");
			$Shoes = mysqli_query($mycon,'SELECT * FROM `perfumes` WHERE Quantity > 0 ORDER BY Model');
...
?>
<button class="button button2" formaction="Perfumes.php">Products</button><br><br><br><br>
